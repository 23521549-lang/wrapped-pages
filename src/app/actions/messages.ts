...
/** Chu sach luu mot to ma to do vua duoc luu o the khac: man sua nhan ra cau nay de moi tai lai. */
export const TRANG_VUA_SUA_NOI_KHAC = "Trang này vừa được sửa ở nơi khác. Tải lại để xem bản mới.";
