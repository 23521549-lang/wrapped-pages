...
/**
 * noiTiep chi co tren to da dang (dau do splitDoc dat): khoi nay bi cat ngang o cho ngat trang, phan dau cua no nam o
 * to truoc. Man doc chi dung dau cua muc danh sach (khong ve lai dau cham); joinSheets dung ca bon loai de noi lai.
 */
export type ParagraphNode = { type: "paragraph"; noiTiep?: true; content?: InlineNode[] };
/**
...
export type BulletListNode = { type: "bulletList"; noiTiep?: true; content: ListItemNode[] };
...
export type BlockquoteNode = { type: "blockquote"; noiTiep?: true; content: TextBlockNode[] };
